...
const getSchedule = new employee("Spencer", "Weekend nights")
...
// function empOne () {
//     getSchedule(new employee);
//     return "Jess works on weekday mornings and afternoons"
// }

// cconsole.log (getSchedule(empOne))

// Need to practice calling a function to another function
