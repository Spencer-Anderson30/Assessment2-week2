...
const greetUser = (userName => greetUser) 
...
const canWeDeliver = deliveryAreaZipCodes.length 
    for (let i = 0; i < deliveryAreaZipCodes.length; i++) {
        console.log(canWeDeliver[i])
    } if (canWeDeliver != deliveryAreaZipCodes) {
        console.log("Sorry we can't deliver to that address")
    } else if (canWeDeliver = deliveryAreaZipCodes) {
...
const canWeDeliverTwo = deliveryAreaZipCodes.includes(84058)
...
const newDeals = newDeals.replace('15%' , '10%')
...
const newDesc = newDesc.replace("March", "April")
console.log(newDesc)
